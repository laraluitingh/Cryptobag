...
public class Coin implements Serializable {
    ...
    public double getChange34h() {
        return change24h;
    }

    public void setChange34h(double change34h) {
        this.change24h = change34h;
    }
    ...
    public static ArrayList<Coin> getCoins() {
        ...
        coins.add(new Coin("Binance", "BNB", 17.20, -5.04, 0.24, 12.51, 2675482775.95, 233309183.3948947));
